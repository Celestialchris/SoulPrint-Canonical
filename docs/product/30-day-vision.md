...
- **Grok (xAI)** — Twitter/X users are a natural audience
- **Copilot (Microsoft)** — large Windows user base
- **Perplexity** — growing AI search tool

### Medium-term additions (Summer 2026)
- **Ollama / local model conversation logs** — self-hosted crowd
- **DeepSeek** — growing in developer circles
- **Mistral Le Chat** — European AI provider, data sovereignty narrative
